...
═══════════════════════════════════════════════════ */
        ...
        .pf-util-link--user:hover {
            color: #0f4a2e;
        }

        .pf-util-link--user.dropdown-toggle::after {
            display: none;
        }
        ...
        .pf-user-menu__item:hover {
            background: #f0f9f4;
            color: #1a6644;
        }

        .pf-user-menu__item--danger {
            color: #c53030 !important;
        }

        .pf-user-menu__item--danger:hover {
