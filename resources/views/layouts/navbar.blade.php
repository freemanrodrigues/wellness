        ...
        <div class="container">
            <div class="pf-topbar__inner">
                ...
                <form class="pf-search" action="{{ url('/search') }}" method="GET" role="search" id="siteSearchForm">
                    <input class="pf-search__input" type="search" name="q" id="siteSearchInput"
                        placeholder="Search products, articles, tips…" value="{{ request('q') }}" autocomplete="off"
                ...
                <div class="pf-topbar__right" id="topbarRight">
                    ...
                    @auth
                        ...
                        <div class="dropdown pf-user-dropdown" id="userDropdownWrap">
                            <a class="pf-util-link pf-util-link--user dropdown-toggle" href="#" id="userDropdownToggle"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="pf-util-icon" viewBox="0 0 16 16">
                                    <path
                            ...
                            <ul class="dropdown-menu dropdown-menu-end pf-user-menu shadow border-0 rounded-3"
                                ...
                                <li>
                                    <a class="dropdown-item pf-user-menu__item" href="{{ route('profile.edit') }}"
                                        id="menuProfile">
                                ...
                                <li>
                                    <form method="POST" action="{{ route('logout') }}" id="logoutForm">
                                        @csrf
                                        <button type="submit"
                                            class="dropdown-item pf-user-menu__item pf-user-menu__item--danger"
                                            id="menuLogout">
                    ...
                    @else
                        ...
                        <a class="pf-util-link" href="{{ route('login') }}" id="signInLink">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor"
                                ...
                                <path fill-rule="evenodd"
                                    d="M11.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L10.293 7.5H1.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708z" />
                            </svg>
                    ...
                    {{-- Cart --}}
                    <a class="pf-util-link pf-util-link--cart" href="{{ route('cart.index') }}" id="cartLink">
                ...
                <button class="pf-toggler d-lg-none" type="button" data-bs-toggle="collapse" data-bs-target="#mobileNav"
    ...
    <div class="pf-mobile-drawer">
        ...
        <div class="pf-mobile-section px-3 pb-2">
            <form class="pf-search pf-search--mobile" action="{{ url('/search') }}" method="GET" role="search">
                <input class="pf-search__input" type="search" name="q" placeholder="Search…" value="{{ request('q') }}"
                    autocomplete="off" aria-label="Site search">
        ...
        <div class="pf-mobile-section">
            ...
            <div>
                <button class="pf-mobile-cat-toggle collapsed w-100 text-start border-0 bg-transparent"
                    ...
                    Nutrition &amp; Diet
                    <svg class="pf-chevron" xmlns="http://www.w3.org/2000/svg" width="14" height="14"
