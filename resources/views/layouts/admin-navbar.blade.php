...
<div class="admin-topbar">
    <div class="admin-topbar__left">
        ...
        <button class="admin-topbar__hamburger d-lg-none" type="button" data-bs-toggle="offcanvas"
            data-bs-target="#adminMobileNav" aria-controls="adminMobileNav" aria-label="Toggle navigation">
            <i class="bi bi-list fs-3"></i>
        </button>

        {{-- Logo / Brand --}}
        <a href="{{ route('dashboard.index') }}" class="admin-topbar__brand">
            <img src="/images/logo.jpg" alt="{{ config('app.name') }}" style="height:30px;" class="me-2"
    ...
    <div class="admin-topbar__right">
        {{-- Notifications --}}
        <div class="dropdown">
            <button class="admin-topbar__icon-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false"
                title="Notifications">
        ...
        {{-- User menu --}}
        <div class="dropdown">
            <button class="admin-topbar__user-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                <i class="bi bi-person-circle fs-5"></i>
                <span
                    class="d-none d-md-inline">{{ auth()->user()->firstname ?? auth()->user()->name ?? 'Admin' }}</span>
    ...
    <div class="admin-mainnav__inner">
        ...
        <div class="admin-mainnav__dropdown-wrap">
            ...
            <div class="admin-mainnav__dropdown">
                ...
                <a href="{{ route('dashboard.brand.index') }}" class="admin-mainnav__dd-item">
                    <i class="bi bi-tags text-indigo"></i>
                    <div><span>Brand</span><small>Manage product companies</small></div>
                </a>
                ...
                <a href="{{ route('dashboard.vpm.index') }}" class="admin-mainnav__dd-item">
                    ...
                    <div><span>Vendor Product Management</span><small>Manage vendor products</small></div>
                </a>
                <a href="#" class="admin-mainnav__dd-item">
...
<div class="offcanvas offcanvas-start d-lg-none" tabindex="-1" id="adminMobileNav"
    ...
    <div class="offcanvas-header bg-dark text-white">
        <h5 class="offcanvas-title d-flex align-items-center gap-2" id="adminMobileNavLabel">
            <img src="/images/logo.jpg" alt="{{ config('app.name') }}" style="height:24px;"
                onerror="this.style.display='none'">
    ...
    <div class="offcanvas-body p-0">
        <div class="accordion accordion-flush" id="adminMobileAccordion">
            ...
            <div class="accordion-item">
                <a href="{{ route('dashboard.index') }}"
                    class="accordion-button no-chevron py-3 px-3 fw-medium text-dark text-decoration-none {{ request()->routeIs('dashboard.index') ? 'active-link' : '' }}">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed py-3 px-3 fw-medium" type="button"
                        data-bs-toggle="collapse" data-bs-target="#mobileOrders">
                ...
                <div id="mobileOrders" class="accordion-collapse collapse" data-bs-parent="#adminMobileAccordion">
                    <div class="accordion-body p-0 bg-light">
                        <div class="list-group list-group-flush">
                            <a href="#"
                                class="list-group-item list-group-item-action bg-transparent border-0 ps-4 py-2">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed py-3 px-3 fw-medium" type="button"
                        data-bs-toggle="collapse" data-bs-target="#mobileIssues">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button
                        class="accordion-button {{ request()->routeIs('dashboard.products.*') ? '' : 'collapsed' }} py-3 px-3 fw-medium"
                        type="button" data-bs-toggle="collapse" data-bs-target="#mobileProducts">
                        <i class="bi bi-box-seam me-2 text-primary"></i> Products
                    </button>
                </h2>
                <div id="mobileProducts"
                    class="accordion-collapse collapse {{ request()->routeIs('dashboard.products.*') ? 'show' : '' }}"
                    data-bs-parent="#adminMobileAccordion">
                    <div class="accordion-body p-0 bg-light">
                        <div class="list-group list-group-flush">
                            <a href="{{ route('dashboard.products.index') }}"
                                class="list-group-item list-group-item-action bg-transparent border-0 ps-4 py-2 {{ request()->routeIs('dashboard.products.index') ? 'fw-bold text-primary' : '' }}">
                                <i class="bi bi-grid text-primary me-2"></i> View Products
                            </a>
                            <a href="{{ route('dashboard.products.create') }}"
                                class="list-group-item list-group-item-action bg-transparent border-0 ps-4 py-2 {{ request()->routeIs('dashboard.products.create') ? 'fw-bold text-success' : '' }}">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button
                        class="accordion-button {{ request()->routeIs('dashboard.category.*', 'dashboard.brand.*', 'dashboard.health-concern.*', 'dashboard.vpm.*') ? '' : 'collapsed' }} py-3 px-3 fw-medium"
                        type="button" data-bs-toggle="collapse" data-bs-target="#mobileMisc">
                        <i class="bi bi-three-dots me-2 text-dark"></i> Miscellaneous
                    </button>
                </h2>
                <div id="mobileMisc"
                    class="accordion-collapse collapse {{ request()->routeIs('dashboard.category.*', 'dashboard.brand.*', 'dashboard.health-concern.*', 'dashboard.vpm.*') ? 'show' : '' }}"
                    data-bs-parent="#adminMobileAccordion">
                    <div class="accordion-body p-0 bg-light">
                        <div class="list-group list-group-flush">
                            <a href="{{ route('dashboard.category.index') }}"
                                class="list-group-item list-group-item-action bg-transparent border-0 ps-4 py-2 {{ request()->routeIs('dashboard.category.*') ? 'fw-bold text-primary' : '' }}">
                                <i class="bi bi-tags me-2" style="color:#6366f1;"></i> Categories
                            </a>
                            <a href="{{ route('dashboard.vpm.index') }}"
                                class="list-group-item list-group-item-action bg-transparent border-0 ps-4 py-2 {{ request()->routeIs('dashboard.vpm.*') ? 'fw-bold text-primary' : '' }}">
                                <i class="bi bi-box-seam me-2" style="color:#6366f1;"></i> Vendor Product Management
                            </a>
...
══════════════════════════════════════════════════════ */
    ...
    .admin-dd .dropdown-item:hover {
        background: #f0f9f4;
        color: #1a6644;
    }

    .admin-dd .dropdown-item.text-danger:hover {
        background: #fff5f5;
        color: #9b2c2c !important;
    }

    .admin-dd .dropdown-header {
        font-size: .72rem;
        color: #9ca3af;
        letter-spacing: .07em;
        text-transform: uppercase;
...
══════════════════════════════════════════════════════ */
    ...
    .admin-mainnav__item:hover {
        background: #f0f9f4;
        color: #1a6644;
    }

    .admin-mainnav__item.active {
        background: #e6f4ed;
        color: #1a6644;
        font-weight: 600;
    }
    ...
    .admin-mainnav__dd-item:hover {
        background: #f0f9f4;
        color: #1a6644;
    }

    .admin-mainnav__dd-item i {
        font-size: 1.05rem;
        flex-shrink: 0;
    }

    .admin-mainnav__dd-item span {
        display: block;
        font-size: .835rem;
        font-weight: 600;
        line-height: 1.2;
    ...
    .admin-mainnav__dd-item:hover small {
        color: #6b9e88;
    }
