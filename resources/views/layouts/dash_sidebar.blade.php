{{-- Shared dashboard sidebar — include inside .dash-wrapper --}}
<aside class="dash-sidebar" id="dashSidebar">
    ...
    <nav class="dash-nav">
        ...
        <a class="dash-nav__link {{ request()->routeIs('dashboard.category.*') ? 'active' : '' }}"
        ...
        <form method="POST" action="{{ route('logout') }}" class="mt-1">
            @csrf
            <button type="submit" class="dash-nav__link dash-nav__link--danger w-100 text-start border-0 bg-transparent">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
