...
<div class="dash-wrapper" style="padding-top: 110px;">
    ...
    <main class="dash-main">
        ...
        <div class="dash-page-header mb-4">
            <div>
                <h1 class="dash-page-title">Edit Brand: {{ $brand->name }}</h1>
        ...
        <form action="{{ route('dashboard.brand.update', $brand) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            <h2 class="h6 fw-bold mb-3">Brand General Details</h2>

                            <div class="row g-3">
                                {{-- Name --}}
                                <div class="col-md-6">
                                    <label for="name" class="form-label fw-semibold small">Brand Name <span class="text-danger">*</span></label>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="meta_description" id="meta_description" rows="3" class="form-control @error('meta_description') is-invalid @enderror">{{ old('meta_description', $brand->meta_description) }}</textarea>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="meta_keywords" id="meta_keywords" rows="2" class="form-control @error('meta_keywords') is-invalid @enderror">{{ old('meta_keywords', $brand->meta_keywords) }}</textarea>
                                    @error('meta_keywords')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3 form-check form-switch">
                                <input type="checkbox" name="status" id="status" class="form-check-input" value="1" {{ old('status', $brand->status) ? 'checked' : '' }}>
                                <label for="status" class="form-check-label fw-semibold small">Active Status</label>
                            </div>

                            <div class="mb-3 form-check form-switch">
                                <input type="checkbox" name="show_in_menu" id="show_in_menu" class="form-check-input" value="1" {{ old('show_in_menu', $brand->show_in_menu) ? 'checked' : '' }}>
                                <label for="show_in_menu" class="form-check-label fw-semibold small">Show in Navigation Menu</label>
                            </div>

                            <div class="mb-3 form-check form-switch">
                                <input type="checkbox" name="show_on_homepage" id="show_on_homepage" class="form-check-input" value="1" {{ old('show_on_homepage', $brand->show_on_homepage) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="sort_order" id="sort_order" class="form-control @error('sort_order') is-invalid @enderror" value="{{ old('sort_order', $brand->sort_order) }}" min="0">
                                @error('sort_order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            <h2 class="h6 fw-bold mb-3">Brand Images</h2>

                            {{-- Image --}}
                            <div class="mb-3">
                                <label for="image" class="form-label fw-semibold small">Brand Logo / Image</label>
                                @if($brand->image)
                                    <div class="mb-2">
                                        <img src="{{ asset($brand->image) }}" alt="Current Image" width="60" height="60" class="rounded border" style="object-fit:cover;">
                                    </div>
                                @endif
                            ...
                            <div class="mb-3">
                                ...
                                @if($brand->icon)
                                    <div class="mb-2">
                                        <img src="{{ asset($brand->icon) }}" alt="Current Icon" width="40" height="40" class="rounded border" style="object-fit:cover;">
                                    </div>
                                @endif
                            ...
                            <div class="mb-3">
                                ...
                                @if($brand->banner)
                                    <div class="mb-2">
                                        <img src="{{ asset($brand->banner) }}" alt="Current Banner" width="100%" height="60" class="rounded border" style="object-fit:cover;">
                                    </div>
                                @endif
